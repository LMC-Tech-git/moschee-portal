...
const SETTINGS_COLLECTION = {
  ...
  schema: [
    ...
    { name: "prayer_source_id", type: "text" },
    { name: "sabah_offset_minutes", type: "number", options: { default: -30 } },
    { name: "tune", type: "text" },
    { name: "ramadan_mode", type: "bool", options: { default: false } },
    { name: "ramadan_start", type: "text" },
    { name: "ramadan_end", type: "text" },
