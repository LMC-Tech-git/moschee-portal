...
export function ContactForm({ apiPath = "/api/contact", mosqueName }: ContactFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Client-seitige Pflichtfeld-Prüfung
      ...
      <div className="space-y-5">
        ...
        <div>
          <label htmlFor="contact-name" className="mb-1.5 block text-sm font-medium text-gray-700">
            {t("fields.name")} <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <input
            id="contact-name"
            name="name"
        ...
        <div>
          <label htmlFor="contact-email" className="mb-1.5 block text-sm font-medium text-gray-700">
            {t("fields.email")} <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <input
            id="contact-email"
            name="email"
        ...
        <div>
          <label htmlFor="contact-organization" className="mb-1.5 block text-sm font-medium text-gray-700">
            {t("fields.organization")}
            <span className="ml-1 text-xs font-normal text-gray-400">({t("optional")})</span>
          </label>
          <input
        ...
        {/* Anfragetyp */}
        <div>
          <label htmlFor="contact-inquiry-type" className="mb-1.5 block text-sm font-medium text-gray-700">
            {t("fields.inquiryType")} <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <select
        ...
        <div>
          <label htmlFor="contact-message" className="mb-1.5 block text-sm font-medium text-gray-700">
            {t("fields.message")} <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <textarea
            id="contact-message"
            name="message"
