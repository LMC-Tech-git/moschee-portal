...
// =========================================
// Semantische Farb-Token (Badge-Konsolidierung)
// Neue Komponenten sollten getBadgeClasses() statt Ad-hoc-Maps nutzen.
// Bestehende *Colors-Maps bleiben abwärtskompatibel.
// =========================================
...
const SEMANTIC_BASE: Record<SemanticColor, string> = {
  success: "emerald",
  warning: "amber",
  danger: "red",
  info: "blue",
...
/**
 * Einheitliche Badge-Klassen für einen semantischen Status.
 * Konkrete Klassen (kein Template-String) — Tailwind-JIT-sicher.
 */
export function getBadgeClasses(color: SemanticColor): string {
  switch (SEMANTIC_BASE[color]) {
    case "emerald":
