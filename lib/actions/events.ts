...
function mapRecordToEvent(record: RecordModel): Event {
  return {
    ...
    recurrence_month_mode: record.recurrence_month_mode || "day",
    recurrence_month_week: record.recurrence_month_week || 1,
    recurrence_month_weekday: record.recurrence_month_weekday || "",
