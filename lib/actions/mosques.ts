...
function mapRecord(record: RecordModel): Mosque {
  return {
    ...
    stripe_charges_enabled: record.stripe_charges_enabled ?? false,
    stripe_payouts_enabled: record.stripe_payouts_enabled ?? false,
    stripe_details_submitted: record.stripe_details_submitted ?? false,
    stripe_requirements_currently_due: record.stripe_requirements_currently_due || [],
    stripe_requirements_eventually_due: record.stripe_requirements_eventually_due || [],
